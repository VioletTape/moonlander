...
#define CS_S LCTL(S(KC_S)) // save all
#define CS_B LCTL(S(KC_B)) // build
#define CS_I LCTL(S(KC_I)) // implementation
...
#define WN_AL LGUI(CT_LEFT)
#define WN_TAB LGUI(KC_TAB)

#define WN_LEFT LGUI(KC_LEFT)
#define WN_RIGHT LGUI(KC_RIGHT)
...
// Chords
// Left Index
#define CMB_CTC CMB_000 // ctrl + C
#define CMB_CTV CMB_001 // ctrl + V
// Left Thumb
#define CMB_SFT CMB_002 // shift
#define CMB_BSP CMB_003 // backspace
#define CMB_ENT CMB_004 // enter
#define CMB_CTL CMB_005 // ctrl
// Left Left Thumb
#define CMB_LYV CMB_006 // layer violet
#define CMB_LYG CMB_007 // layer green
// Right Thumb
#define CMB_LAN CMB_008 // change language
#define CMB_DOT CMB_009 // .
#define CMB_SPC CMB_010 // space
#define CMB_ALT CMB_011 // alt
...
#define TT_DIC (TT_000 + L_DIC)

// Этот макрос нужен, чтобы задавать одинаковые слои (в том числе и шифтовый слой) для английского и русского языка.
// В итоге их отличия будут только в буквах.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LANG_TWO_LAYERS(
    ...
    /* Left hand */
             AC_ACT,  EN_M,    EN_Y,    EN_D,    EN_G,
             EN_A,    EN_R,    EN_E,    EN_S,    EN_F,
    AG_RPRN, EN_X,    EN_Z,    EN_J,    EN_V,    KC_TAB,

    /* Right hand */
    XXXXXXX, EN_W,    EN_H,    EN_C,    XXXXXXX,
    EN_K,    EN_T,    EN_N,    EN_I,    EN_O,    KC_ENT,
    EN_B,    EN_P,    EN_L,    EN_U,    EN_Q,    CT_ENT,

    /* ---------------------------- Shift layer ---------------------------- */
    /* Left hand */
             AC_ACT,  EN_S_M,    EN_S_Y,    EN_S_D,    EN_S_G,
             EN_S_A,  EN_S_R,    EN_S_E,    EN_S_S,    EN_S_F,
    _______, EN_S_X,  EN_S_Z,    EN_S_J,    EN_S_V,  KC_TAB,

    /* Right hand */
    _______,  EN_S_W,    EN_S_H,    EN_S_C,  _______,
    EN_S_K,    EN_S_T,    EN_S_N,    EN_S_I,    EN_S_O,  _______,
    EN_S_B,    EN_S_P,    EN_S_L,    EN_S_U,    EN_S_Q,  _______
  )
...
const ComboWithKeycode combos[] PROGMEM = {
  // Left Index
  //   что                как
  CHORD(CT_C,    /* <- */ CMB_CTC), // Ctrl + C
  CHORD(CT_V,    /* <- */ CMB_CTV), // Ctrl + V
  CHORD(CT_X,    /* <- */ CMB_CTC, CMB_CTV), // Ctrl + X

  // Right Index
  CHORD(CT_S, /* <- */ CMB_LB3, CMB_LB1), //  < <- { (
  ...
  CHORD(AG_SDOT, /* <- */ CMB_DOT, CMB_SFT),
  CHORD(LA_SYNC, /* <- */ CMB_LAN, CMB_DOT),
  CHORD(CTAL_EN, /* <- */ CMB_SFT, CMB_ALT),
  CHORD(SHAL_EN, /* <- */ CMB_DOT, CMB_ALT),
  CHORD(WIN_EN,  /* <- */ CMB_SFT, CMB_DOT, CMB_ALT),
